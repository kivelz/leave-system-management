...
public class DataLoader implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		entities.add(role); entities.add(role1); entities.add(role3);
		...
		elist.add(emp1); elist.add(emp2); elist.add(emp3); elist.add(emp4); elist.add(emp5); elist.add(emp6); elist.add(emp7);
